...
void BasicWidget::initializeGL()
{
  ...
  modelSelectedIndex_ = 0;
  renderables_.push_back(Renderable::createFromFile("../objects/bunny_centered.obj"));
  renderables_.push_back(Renderable::createFromFile("../objects/monkey_centered.obj"));
